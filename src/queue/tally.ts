...
const LATEST_CHARACTER_BANNER = 300099;
const LATEST_WEAPON_BANNER = 400098;
const LATEST_CHRONICLED_BANNER = 500006;
...
for (let i = 0; i < TOTAL_CHRONICLED_BANNER; i++) {
  void queue.add('wish-tally-calculate', LATEST_CHRONICLED_BANNER - i);
}
